# Example project bootstrap for WISDOM v1.7.0
...
using it. Keep the complete v1.7.0 archive under the governing project root,
for example at `vendor/wisdom/v1.7.0/`.

> Resolve the governing repository root first. Treat
> `<root>/vendor/wisdom/v1.7.0/WISDOM.md` as the sole portable WISDOM source.
> Run its own `scripts/load_compiled_wisdom.py --source
> <root>/vendor/wisdom/v1.7.0/WISDOM.md --discover` before routing. Choose the
